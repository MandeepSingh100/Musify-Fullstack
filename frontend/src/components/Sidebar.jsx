    ...
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 m-2 bg-[#121212] rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4">
          ...
          <button className="px-4 cursor-pointer py-1.5 bg-white text-black text-[15px] rounded-full mt-4 hover:bg-gray-500 hover:text-white">
            Browse Podcasts
          </button>
        </div>
        ...
        {user && user.role === "admin" && (
          <button
            className="m-6 px-4 py-1.5 bg-white text-black text-[15px] cursor-pointer rounded-full mt-4 hover:bg-green-500 hover:text-white"
