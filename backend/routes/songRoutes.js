...
import { addSong, addThumbnail, createAlbum, deleteSong, getAllAlbums, getAllSongs, getAllSongsByAlbum, getSingsong, } from "../controllers/songControllers.js";
...
router.get("/single/:id", isAuth, getSingsong);
